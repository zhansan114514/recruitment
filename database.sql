...
(
    ...
    question1   varchar(50) null DEFAULT -1 comment '问题1',
    score1      int         null DEFAULT -1 comment '第一道题的成绩',
    question2   varchar(50) null DEFAULT -1 comment '问题2',
    score2      int         null DEFAULT -1 comment '第二道题的成绩',
    question3   varchar(50) null DEFAULT -1 comment '问题3',
    score3      int         null DEFAULT -1 comment '第三道题的成绩',
    question4   varchar(50) null DEFAULT -1 comment '问题4',
    score4      int         null DEFAULT -1 comment '第四道题的成绩',
    question5   varchar(50) null DEFAULT -1 comment '问题5',
    score5      int         null DEFAULT -1 comment '第五道题的成绩',
    question6   varchar(50) null DEFAULT -1 comment '问题6',
    score6      int         null DEFAULT -1 comment '第六道题的成绩',
    question7   varchar(50) null DEFAULT -1 comment '问题7',
    score7      int         null DEFAULT -1 comment '第七道题的成绩',
    question8   varchar(50) null DEFAULT -1 comment '问题8',
...
(
    ...
    question8   varchar(50) null DEFAULT -1 comment '问题8',
    score8      int         null DEFAULT -1 comment '第八道题的成绩',
    question9   varchar(50) null DEFAULT -1 comment '问题9',
    score9      int         null DEFAULT -1 comment '第九道题的成绩',
    question10  varchar(50) null DEFAULT -1 comment '问题10',
    score10     int         null DEFAULT -1 comment '第十道题的成绩',
    question11  varchar(50) null DEFAULT -1 comment '问题11',
...
(
    studentid   char(20)    not null comment '学号'
        primary key,
    username    char(20)    not null comment '用户名',
    question1   varchar(50) DEFAULT -1 null comment '问题1',
    score1      int         DEFAULT -1 null comment '第一道题的成绩',
    question2   varchar(50) DEFAULT -1 null comment '问题2',
    score2      int         DEFAULT -1 null comment '第二道题的成绩',
    question3   varchar(50) DEFAULT -1 null comment '问题3',
    score3      int         DEFAULT -1 null comment '第三道题的成绩',
    question4   varchar(50) DEFAULT -1 null comment '问题4',
    score4      int         DEFAULT -1 null comment '第四道题的成绩',
    question5   varchar(50) DEFAULT -1 null comment '问题5',
    score5      int         DEFAULT -1 null comment '第五道题的成绩',
    question6   varchar(50) DEFAULT -1 null comment '问题6',
    score6      int         DEFAULT -1 null comment '第六道题的成绩',
    question7   varchar(50) DEFAULT -1 null comment '问题7',
    score7      int         DEFAULT -1 null comment '第七道题的成绩',
    question8   varchar(50) DEFAULT -1 null comment '问题8',
    score8      int         DEFAULT -1 null comment '第八道题的成绩',
    question9   varchar(50) DEFAULT -1 null comment '问题9',
    score9      int         DEFAULT -1 null comment '第九道题的成绩',
    question10  varchar(50) DEFAULT -1 null comment '问题10',
